// Display formatters. Ported verbatim from the ns-retail extension's
// format.js — no platform-specific code (Intl is available everywhere).
...
// reason. Pipeline reasons are often a prefix + a raw provider JSON blob.
