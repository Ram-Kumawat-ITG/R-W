...
//
// Used by QBO/NMI HTTP clients to absorb transient 5xx / network errors.
// Permanent errors (4xx auth/validation) should be thrown with
// `err.permanent = true` so they bypass retry.
