...
import { registerProcessDropshipPaymentsJob, PROCESS_DROPSHIP_PAYMENTS_JOB } from './processDropshipPayments.job'
...
export const JOB_NAMES = {
  ...
  PROCESS_DROPSHIP_PAYMENTS: PROCESS_DROPSHIP_PAYMENTS_JOB,
}
...
export function registerJobs(agenda) {
  ...
  registerProcessDropshipPaymentsJob(agenda)
}
