...
export const TAX_NOTE_MAP = [
  { field: 'taxIdType',        key: 'Tax-ID-Type' },
  { field: 'taxId',            key: 'Tax-ID' },
  { field: 'salesPermit',      key: 'Sales-Permit-URL' },
  { field: 'exemptState',      key: 'Exempt-State' },
  { field: 'itemsToResell',    key: 'Items-To-Resell' },
  { field: 'businessActivity', key: 'Business-Activity' },
]
