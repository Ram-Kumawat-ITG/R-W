...
class $ {
  ...
  validateWebhook(n, t, e) {
    ...
    if (a != null) {
      const o = e.normalize("NFKD"), l = Buffer.from(o, "utf8"), _ = Buffer.from(n).toString("utf8").replace(/("weight":\s*)(\d+)(\s*)(?=,|\})/g, "$1$2.0"), v = `hmac-sha256-hex=${x.createHmac("sha256", l).update(_, "utf-8").digest("hex")}`;
      try {
...
const A = {
  ...
  class {
    ...
    static _convertToEasyPostObject(t, e) {
      ...
      if (typeof t == "object" && t !== null) {
        let s;
        if (R[t.object] !== void 0)
          s = new R[t.object]();
        else if (t.id !== void 0 && A[t.id.substr(0, t.id.indexOf("_"))] !== void 0) {
    ...
    static async _getNextPage(t, e, s, a = null, c = {}) {
      ...
      if (i == null || i.length == 0 || !s.has_more)
        throw new w();
      const o = (v = (m = s._params) != null ? m : i[0]._params) != null ? v : {}, l = {
        ...o,
        page_size: (E = o.page_size) != null ? E : a,
        before_id: i[i.length - 1].id,
        ...c
      }, _ = await this._all(t, l);
  ...
  class extends u(r) {
    ...
    static async create(t) {
      const e = "addresses", s = {};
      return t.verify && (s.verify = t.verify, delete t.verify), t.verify_strict && (s.verify_strict = t.verify_strict, delete t.verify_strict), t.verify_carrier && (s.verify_carrier = t.verify_carrier, delete t.verify_carrier), s.address = t, this._create(e, s);
    }
    /**
    ...
    static async createAndVerify(t) {
      const e = "addresses/create_and_verify", s = {};
      t.verify_carrier && (s.verify_carrier = t.verify_carrier, delete t.verify_carrier), s.address = t;
      try {
  ...
  class extends u(r) {
     ...
     */
    static async disable(t) {
      const e = `api_keys/${t}/disable`;
      try {
        const s = await r._post(e);
        return this._convertToEasyPostObject(s.body);
      } catch (s) {
  ...
  class extends u(r) {
     ...
     * @returns {Batch} - The updated batch.
     */
    static async generateLabel(t, e = jt) {
...
const kt = (r) => (
  ...
  class extends u(r) {
    ...
    static async _getPaymentInfo(t) {
      ...
      let c, i, o;
      const l = "The chosen payment method is not valid. Please try again.";
  ...
  class extends u(r) {
     ...
     */
    static async createAccountLink(t = {}) {
      const e = "customer_portal/account_link";
      try {
  ...
  class extends u(r) {
     ...
     * @returns {Object} - An object containing the created session.
     */
    static async createSession(t = {}) {
      const e = "embeddables/session";
      try {
        const s = await r._post(e, t);
        return this._convertToEasyPostObject(s.body, t);
      } catch (s) {
  ...
  class extends u(r) {
     ...
     * @returns {Object}
     */
    static async registerAddress(t, e) {
      const s = this._wrapAddressValidation(e), a = `fedex_registrations/${t}/address`;
      try {
        const c = await r._post(a, s);
        return this._convertToEasyPostObject(c.body, e);
      } catch (c) {
        return Promise.reject(c);
      }
    }
     ...
     * @returns {Object}
     */
    static async requestPin(t, e) {
      const s = {
        pin_method: {
          option: e
        }
      }, a = `fedex_registrations/${t}/pin`;
      try {
        const c = await r._post(a, s);
        return this._convertToEasyPostObject(c.body, s);
      } catch (c) {
        return Promise.reject(c);
      }
    }
     ...
     * @returns {Object}
     */
    static async validatePin(t, e) {
      const s = this._wrapPinValidation(e), a = `fedex_registrations/${t}/pin/validate`;
      try {
        const c = await r._post(a, s);
        return this._convertToEasyPostObject(c.body, e);
      } catch (c) {
     ...
     * @returns {Object}
     */
    static async submitInvoice(t, e) {
      const s = this._wrapInvoiceValidation(e), a = `fedex_registrations/${t}/invoice`;
      try {
        const c = await r._post(a, s);
        return this._convertToEasyPostObject(c.body, e);
      } catch (c) {
     ...
     */
    static _wrapAddressValidation(t) {
      const e = {};
      if (t.address_validation) {
        const s = { ...t.address_validation };
        this._ensureNameField(s), e.address_validation = s;
      }
      return t.easypost_details && (e.easypost_details = t.easypost_details), e;
    }
    /**
     ...
     */
    static _wrapPinValidation(t) {
      const e = {};
      if (t.pin_validation) {
        const s = { ...t.pin_validation };
        this._ensureNameField(s), e.pin_validation = s;
      }
      return t.easypost_details && (e.easypost_details = t.easypost_details), e;
    }
    /**
     ...
     */
    static _wrapInvoiceValidation(t) {
      const e = {};
      if (t.invoice_validation) {
        const s = { ...t.invoice_validation };
        this._ensureNameField(s), e.invoice_validation = s;
      }
      return t.easypost_details && (e.easypost_details = t.easypost_details), e;
    }
    /**
...
async function Qt(r, n, t, e) {
  const s = j(r, n), a = "credit_cards", c = { credit_card: { stripe_object_id: t, priority: e } };
...
const Zt = (r) => (
  ...
  class extends u(r) {
    ...
    static async addBankAccountFromStripe(t, e, s, a = "primary") {
      const c = j(r, t), i = {
        ...
        mandate_data: s,
        priority: a
      }, l = await c._post("bank_accounts", i);
      return this._convertToEasyPostObject(l.body, i);
    }
    /**
  ...
  class extends u(r) {
    ...
    static async buy(t, e, s = null, a = null) {
      ...
      try {
        const l = await r._post(i, o);
        return this._convertToEasyPostObject(l.body, o);
      } catch (l) {
  ...
  class extends u(r) {
     ...
     */
    static async retrieveBatch(t = {}) {
      const e = "trackers/batch";
      try {
        const s = await r._post(e, t);
        return this._convertToEasyPostObject(s.body, t);
      } catch (s) {
  ...
  class extends u(r) {
    ...
    static async _getNextPage(t, e, s, a = null) {
      ...
      if (c == null || c.length == 0 || !s.has_more)
        throw new w();
      const i = (m = (_ = s._params) != null ? _ : c[0]._params) != null ? m : {}, o = {
        ...i,
        page_size: (v = i.page_size) != null ? v : a,
        after_id: c[c.length - 1].id
      }, l = await this._all(t, o);
      if (l == null || l[e].length == 0)
        throw new w();
      return l;
    }
  }
...
class p {
  constructor(n, t = {}) {
    ...
    this.key = n, this.timeout = s || p.DEFAULT_TIMEOUT, this.baseUrl = a || p.DEFAULT_BASE_URL, this.agent = k, this.requestMiddleware = i, this.requestHooks = [], this.responseHooks = [], this.Utils = new $(), c && (this.agent = c(this.agent)), this._attachServices(p.SERVICES);
  }
  /**
   ...
   */
  async makeApiCall(n, t, e = {}) {
    return (await this._request(t, n, e)).body;
  }
  /**
  ...
  static copyClient(n, t = {}) {
    const { apiKey: e, useProxy: s, timeout: a, baseUrl: c, superagentMiddleware: i, requestMiddleware: o } = t, l = i ? i(n.agent) : n.agent;
  ...
  async _request(n = "", t = p.METHODS.GET, e = {}, s = {}) {
    ...
    const o = new URL(a);
    e !== void 0 && (t === p.METHODS.GET || t === p.METHODS.DELETE ? (i.query(e), Object.entries(e).forEach(([_, m]) => {
      o.searchParams.append(_, m);
    })) : i.send(e));
    const l = {
      method: t,
      path: o.toString(),
    ...
    this.requestHooks.forEach((_) => _(l));
    try {
      const _ = await i;
      if (this.responseHooks.length > 0) {
        const m = this._createResponseHooksValue(l, _);
        this.responseHooks.forEach((v) => v(m));
      }
      return _;
    } catch (_) {
      if (_.response && _.response.body) {
        const m = this._createResponseHooksValue(l, _.response);
        throw this.responseHooks.forEach((v) => v(m)), Pt.handleApiError(_.response);
      } else
        throw _;
    }
  }
